...
export class LibVoxelLidarDecoder {
    ...
    private malloc: Function | null = null;
    private free: Function | null = null;
    private generate: Function | null = null;
    ...
    async init(): Promise<void> {
        ...
        this.generate = this.wasmInstance.exports.e as Function;
        this.malloc = this.wasmInstance.exports.f as Function;
        this.free = this.wasmInstance.exports.g as Function;

        // Allocate buffers
        this.input = (this.malloc as Function)(61440);
        this.decompressBuffer = (this.malloc as Function)(80000);
        this.positions = (this.malloc as Function)(2880000);
        this.uvs = (this.malloc as Function)(1920000);
        this.indices = (this.malloc as Function)(5760000);
        this.decompressedSize = (this.malloc as Function)(4);
        this.faceCount = (this.malloc as Function)(4);
        this.pointCount = (this.malloc as Function)(4);
    }

    private adjust_memory_size(t: number): number {
    ...
    private copy_memory_region(target: number, start: number, length: number): void {
        ...
        buffer.copyWithin(target, start, start + length);
    }
