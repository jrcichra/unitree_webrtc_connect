...
export enum WebRTCConnectionMethod {
    LocalAP = 1,
    LocalSTA = 2,
    Remote = 3,
}
...
export const RTC_TOPIC: Record<string, string> = {
...
export const MCF_CMD: Record<string, number> = {
...
export const AUDIO_API: Record<string, number> = {
